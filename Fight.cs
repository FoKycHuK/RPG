...
namespace MyRPG
{
    ...
    public partial class Fight : Form
    {
        ...
        public Fight(Creatures.Player player, IMonster monster)
        {
            ...
            ClientSize = new Size(ElementSize * 8, ElementSize * 2);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawImage(monsterIcon, ClientSize.Width - ElementSize - 10, 0);
            e.Graphics.ResetTransform();
            e.Graphics.DrawString("HP: " + player.hp.ToString(), new Font("Arial", 16), Brushes.Red, 0, ElementSize);
            e.Graphics.DrawString("HP: " + monster.hp.ToString(), new Font("Arial", 16), Brushes.Red, ClientSize.Width - ElementSize * 4 , ElementSize);
